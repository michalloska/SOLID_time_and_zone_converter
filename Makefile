...
TEST_OBJECTS = ./tests/mainGTest.o ./tests/TimeTestSuite.o ./tests/TimeZoneTestSuite.o ./tests/TimeZoneConverterTestSuite.o ./tests/TimeConversionConsoleParserTestSuite.o 
